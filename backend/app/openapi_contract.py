...
OPERATION_CONTRACTS: dict[tuple[str, str], OperationContract] = {
    ...
    ("GET", "/api/ingredient-requests"): _operation(
        ...
        "staff_internal",
        "frontend/features/ingredients/review/ingredient-request-review-api.ts",
        "frontend/features/ingredients/review/ingredient-request-review-workspace.tsx",
    ),
    ("POST", "/api/ingredient-requests"): _operation(
        "create_ingredient_request_api_ingredient_requests_post",
        "active_consumer",
        "frontend/features/ingredients/requests/ingredient-request-api.ts",
    ),
    ...
    ("GET", "/api/ingredients"): _operation(
        ...
        "active_consumer",
        "frontend/features/ingredients/catalog/ingredient-catalog-api.ts",
    ),
    ...
    ("GET", "/api/recipe-categories"): _operation(
        ...
        "active_consumer",
        "frontend/features/recipes/browse/recipe-browse-server-api.ts",
        "frontend/features/recipes/shared/recipe-category-client-api.ts",
    ),
    ...
    ("GET", "/api/recipes/viewer-states"): _operation(
        ...
        "active_consumer",
        "frontend/features/recipes/shared/interaction-api.ts",
    ),
    ("GET", "/api/recipes/current/{recipe_id}"): _operation(
        "current_recipe_detail_api_recipes_current__recipe_id__get",
        "active_consumer",
    ...
    ("GET", "/api/recipes/{recipe_version_id}/history"): _operation(
        "recipe_history_api_recipes__recipe_version_id__history_get",
        "active_consumer",
        "frontend/features/recipes/detail/recipe-detail-server-api.ts",
    ),
