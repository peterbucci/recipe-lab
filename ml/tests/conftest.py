...
DUPLICATE_FIXTURE_PATH = Path(__file__).parent / "fixtures" / "duplicate_candidates_v1.json"
...
@pytest.fixture(scope="session")
def duplicate_benchmark() -> DuplicateBenchmark:
    return load_duplicate_benchmark(DUPLICATE_FIXTURE_PATH)
