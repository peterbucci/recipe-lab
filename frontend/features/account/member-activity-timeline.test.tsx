...
import type { MemberActivityPage } from "./member-activity-api";
...
vi.mock("./member-activity-api", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("./member-activity-api")>();
...
function renderTimeline() {
  return render(<MemberActivityTimeline userId={MEMBER.id} />);
}
