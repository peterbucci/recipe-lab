...
vi.mock("../duplicate/recipe-duplicate-api", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../duplicate/recipe-duplicate-api")>();
  return { ...actual, createRecipeDraftDuplicatePreflight: mocks.preflight };
});

vi.mock("./recipe-publication-api", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("./recipe-publication-api")>();
...
export { AuthApiError } from "../../../auth/auth-api";
export { RecipeDuplicateApiError } from "../duplicate/recipe-duplicate-api";
export { RecipePublicationApiError } from "./recipe-publication-api";
