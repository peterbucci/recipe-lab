...
vi.mock("../draft/recipe-draft-api", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("../draft/recipe-draft-api")>();
  return {
    ...actual,
...
export { RecipeDraftApiError } from "../draft/recipe-draft-api";
