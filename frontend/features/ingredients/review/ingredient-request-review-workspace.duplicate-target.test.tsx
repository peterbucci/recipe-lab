...
import type { CatalogIngredientPage } from "../ingredient-model";
import type { IngredientCatalogReviewPage } from "./ingredient-request-review-api";
import {
  CURATOR_ID,
  INGREDIENT_ID,
  REQUEST_ID,
  ...
  reviewItem,
  reviewPage,
} from "./ingredient-request-review-fixtures-test-support";
import {
